...
func TestBalance1(t *testing.T) {
	var COMPARE = []string{"2", "4", "6", "1", "2", "3", "_", "1", "_", "_", "3", "_", "5", "6", "7", "_", "5", "_", "_", "7", "_"}
	r := New(cmp.F_int)
	assertReplaceOrInsert(r, key1, key1, false, t)
	assertReplaceOrInsert(r, key2, key2, false, t)
...
// TestIntegrity1
func TestIntegrity1(t *testing.T) {
	r := New(cmp.F_int)
	assertReplaceOrInsert(r, key5, key5, false, t)
	assertReplaceOrInsert(r, key4, key4, false, t)
	assertReplaceOrInsert(r, key3, key3, false, t)
...
// TestIntegrity2
func TestIntegrity2(t *testing.T) {
	r := New(cmp.F_int)
	assertReplaceOrInsert(r, key1, key1, false, t)
	assertReplaceOrInsert(r, key9, key9, false, t)
	assertReplaceOrInsert(r, key2, key2, false, t)
...
func Test_Tree3(t *testing.T) {
	var COMPARE = []string{"+1", "3", "_", "_", "+1", "_"}
	r := New(cmp.F_int)
	assertReplaceOrInsert(r, key2, key2, false, t)
	assertReplaceOrInsert(r, key1, key1, false, t)
	assertReplaceOrInsert(r, key3, key3, false, t)
...
func Test_Tree4(t *testing.T) {
	var COMPARE = []string{"1", "2", "3", "_", "1", "_", "_", "3", "_"}
	r := New(cmp.F_int)
	assertReplaceOrInsert(r, key4, key4, false, t)
	assertReplaceOrInsert(r, key1, key1, false, t)
	assertReplaceOrInsert(r, key3, key3, false, t)
